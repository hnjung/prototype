...
$.each(iaMainCommData.list , function(){
...
$.each(iaCompensationData.list , function(){
	iaAllData.list.push(this);
});
$.each(iaCustomData.list , function(){
	iaAllData.list.push(this);
});
$.each(iaLoginJoinData.list , function(){
	iaAllData.list.push(this);
});
$.each(iaDocData.list , function(){
	iaAllData.list.push(this);
});
...
/* 카테고리별 데이터 가져오기 */
/** 메인/공통 */
const mainCommData = JSON.parse(JSON.stringify(iaMainCommData));
iaData.set('tabMainComm', mainCommData);
...
/** 보상 */
const compensationData = JSON.parse(JSON.stringify(iaCompensationData));
iaData.set('tabCompensation', compensationData);
...
/** 로그인/인증센터/설정/회원가입 */
const loginJoinData = JSON.parse(JSON.stringify(iaLoginJoinData));
iaData.set('tabLoginJoin', loginJoinData);

/** 약관/동의서 */
const docData = JSON.parse(JSON.stringify(iaDocData));
iaData.set('tabDoc', docData);
